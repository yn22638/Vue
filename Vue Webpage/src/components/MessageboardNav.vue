<template>
  <div class="MessageboardNav">
    <ul>
      ...
      <li :style="[liuyanbgc]">
        <router-link to="/Messageboard" :style="[liuyancolor]">{{liuyan}}</router-link>
      </li>
      <li>
...
export default {
  ...
  data() {
    return {
      ...
      liuyanbgc: {"background-color":"#171746"},
    };
  },
  methods:{
    // 点击事件
    ...
    //   this.bgc = {"background-color":"#171746"};
    // },
  }
};
</script>
